...
func (p *NetINodeDriver) FetchNetINodeFromDB(pNetINode *sdfsapitypes.NetINode) error {
	var (
		sess    sdbapi.Session
		sqlRows *sql.Rows
		err     error
...
func (p *NetINodeDriver) StoreNetINodeInDB(pNetINode *sdfsapitypes.NetINode) error {
	var (
		sess          sdbapi.Session
