...
func (p *NetINodeDriver) unsafeMemBlockRebaseNetBlock(uNetINode sdfsapitypes.NetINodeUintptr,
	...
	var (
		...
		pMemBlock      *sdfsapitypes.MemBlock
		uTmpMemBlock   sdfsapitypes.MemBlockUintptr
		err            error
	)
